...
public class BitSetEnumerationBenchmarks
{
    ...
    private struct SumAction : IBitAction
    {
        public int Sum;
        public void Invoke(int bitIndex) => Sum += bitIndex;
    }
}
