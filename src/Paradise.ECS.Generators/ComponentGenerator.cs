...
public class ComponentGenerator : IIncrementalGenerator
{
        ...
        GeneratorConfig config)
    {
        ...
        var userDefinedEntityTags = components.Any(c => c.TypeName == "EntityTags");
        ...
        if (validComponents.Count > 0)
        {
            ...
            foreach (var component in validComponents)
            {
                ...
                var isAutoGenerated = autoGenerateEntityTags && component.TypeName == "EntityTags";
                GeneratePartialStruct(context, component, tagMaskType, "", isAutoGenerated);
            }
    ...
    private static void GeneratePartialStruct(SourceProductionContext context, TypeInfo info, string tagMaskType, string filePrefix, bool isAutoGenerated = false)
    {
