...
{
    private const string ComponentAttributeFullName = "Paradise.ECS.Concurrent.ComponentAttribute";
    private const string RegistryNamespaceAttributeFullName = "Paradise.ECS.Concurrent.ComponentRegistryNamespaceAttribute";
    private const string EcsLimitsFullName = "Paradise.ECS.Concurrent.EcsLimits";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var rootNamespace = rootNamespaceFromAttribute
            ...
            .Select(static (pair, _) => pair.Left ?? pair.Right ?? "Paradise.ECS.Concurrent");
    ...
    private static void GenerateCustomStorageType(SourceProductionContext context, string typeName, int ulongCount)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("namespace Paradise.ECS.Concurrent;");
        sb.AppendLine();
        ...
        sb.AppendLine($"public struct {typeName} : global::Paradise.ECS.Concurrent.IStorage");
        sb.AppendLine("{");
    ...
    private static void GenerateGlobalUsings(SourceProductionContext context, int componentCount)
    {
        ...
        sb.AppendLine();
        sb.AppendLine($"global using ComponentMask = global::Paradise.ECS.Concurrent.ImmutableBitSet<global::Paradise.ECS.Concurrent.{bitType}>;");
    ...
    private static void GenerateComponentRegistry(SourceProductionContext context, List<ComponentInfo> components, string rootNamespace)
    {
        ...
        sb.AppendLine("/// </summary>");
        sb.AppendLine("public sealed class ComponentRegistry : global::Paradise.ECS.Concurrent.IComponentRegistry");
        sb.AppendLine("{");
        sb.AppendLine("    private static global::System.Collections.Frozen.FrozenDictionary<global::System.Type, global::Paradise.ECS.Concurrent.ComponentId>? s_typeToId;");
        sb.AppendLine("    private static global::System.Collections.Frozen.FrozenDictionary<global::System.Guid, global::Paradise.ECS.Concurrent.ComponentId>? s_guidToId;");
        sb.AppendLine("    private static global::System.Collections.Immutable.ImmutableArray<global::Paradise.ECS.Concurrent.ComponentTypeInfo> s_typeInfos;");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        ...
        sb.AppendLine("        var components = new (global::System.Type Type, global::System.Guid Guid, int Size, int Alignment, int ManualId, global::System.Action<global::Paradise.ECS.Concurrent.ComponentId> SetId)[]");
        sb.AppendLine("        {");
        foreach (var component in components)
        {
            ...
            sb.AppendLine($"            (typeof(global::{component.FullyQualifiedName}), {guid}, global::{component.FullyQualifiedName}.Size, global::{component.FullyQualifiedName}.Alignment, {manualId}, (global::Paradise.ECS.Concurrent.ComponentId id) => global::{component.FullyQualifiedName}.TypeId = id),");
        }
        sb.AppendLine("        };");
        sb.AppendLine();
        sb.AppendLine("        // Build lookup dictionaries and assign IDs");
        sb.AppendLine("        var typeToId = new global::System.Collections.Generic.Dictionary<global::System.Type, global::Paradise.ECS.Concurrent.ComponentId>(components.Length);");
        sb.AppendLine("        var guidToId = new global::System.Collections.Generic.Dictionary<global::System.Guid, global::Paradise.ECS.Concurrent.ComponentId>();");
        ...
        sb.AppendLine("            {");
        sb.AppendLine("                var id = new global::Paradise.ECS.Concurrent.ComponentId(comp.ManualId);");
        ...
        sb.AppendLine("            var id = new global::Paradise.ECS.Concurrent.ComponentId(nextId);");
        sb.AppendLine("            comp.SetId(id);");
        sb.AppendLine("            typeToId[comp.Type] = id;");
        sb.AppendLine("            if (comp.Guid != global::System.Guid.Empty)");
        sb.AppendLine("                guidToId[comp.Guid] = id;");
        ...
        sb.AppendLine("        var typeInfosBuilder = global::System.Collections.Immutable.ImmutableArray.CreateBuilder<global::Paradise.ECS.Concurrent.ComponentTypeInfo>(maxId + 1);");
        sb.AppendLine("        for (int i = 0; i <= maxId; i++)");
        sb.AppendLine("            typeInfosBuilder.Add(default);");
        sb.AppendLine("        foreach (var comp in components)");
        sb.AppendLine("        {");
        sb.AppendLine("            var id = typeToId[comp.Type];");
        sb.AppendLine("            typeInfosBuilder[id.Value] = new global::Paradise.ECS.Concurrent.ComponentTypeInfo(id, comp.Size, comp.Alignment);");
        sb.AppendLine("        }");
        sb.AppendLine();
        ...
        sb.AppendLine("    public static global::Paradise.ECS.Concurrent.ComponentId GetId(global::System.Type type)");
        sb.AppendLine("    {");
        sb.AppendLine("        return s_typeToId!.TryGetValue(type, out var id) ? id : global::Paradise.ECS.Concurrent.ComponentId.Invalid;");
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        ...
        sb.AppendLine("    public static bool TryGetId(global::System.Type type, out global::Paradise.ECS.Concurrent.ComponentId id)");
        sb.AppendLine("    {");
        ...
        sb.AppendLine("    /// <returns>The ComponentId, or <see cref=\"ComponentId.Invalid\"/> if not found.</returns>");
        sb.AppendLine("    public static global::Paradise.ECS.Concurrent.ComponentId GetId(global::System.Guid guid)");
        sb.AppendLine("    {");
        sb.AppendLine("        return s_guidToId!.TryGetValue(guid, out var id) ? id : global::Paradise.ECS.Concurrent.ComponentId.Invalid;");
        sb.AppendLine("    }");
        sb.AppendLine();
        sb.AppendLine("    /// <summary>");
        ...
        sb.AppendLine("    public static bool TryGetId(global::System.Guid guid, out global::Paradise.ECS.Concurrent.ComponentId id)");
        sb.AppendLine("    {");
        ...
        sb.AppendLine("    /// </summary>");
        sb.AppendLine("    public static global::System.Collections.Immutable.ImmutableArray<global::Paradise.ECS.Concurrent.ComponentTypeInfo> TypeInfos => s_typeInfos;");
        sb.AppendLine("}");
        ...
        ComponentInfo component)
    {
        ...
        sb.AppendLine($"{indent}partial struct {component.TypeName} : global::Paradise.ECS.Concurrent.IComponent");
        sb.AppendLine($"{indent}{{");
        sb.AppendLine($"{indent}    /// <summary>The unique component type ID assigned at module initialization (sorted by alignment).</summary>");
        sb.AppendLine($"{indent}    public static global::Paradise.ECS.Concurrent.ComponentId TypeId {{ get; internal set; }} = global::Paradise.ECS.Concurrent.ComponentId.Invalid;");
        sb.AppendLine();
        ...
        {
            sb.AppendLine($"{indent}    public static int Alignment {{ get; }} = global::Paradise.ECS.Concurrent.Memory.AlignOf<global::{component.FullyQualifiedName}>();");
        }
        sb.AppendLine($"{indent}}}");
