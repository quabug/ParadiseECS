...
public sealed class ChunkManagerTests
{
    ...
    {
        var manager = new ChunkManager<DefaultConfig>(NativeMemoryAllocator.Shared);
        manager.Dispose();
    ...
    {
        var manager = new ChunkManager<DefaultConfig>(NativeMemoryAllocator.Shared, initialCapacity: 16);
        manager.Dispose();
    ...
    {
        using var manager = new ChunkManager<DefaultConfig>(NativeMemoryAllocator.Shared);
