...
public sealed class ChunkManagerTests
{
    ...
    {
        var manager = new ChunkManager<DefaultConfig>(new DefaultConfig(), NativeMemoryAllocator.Shared);
        manager.Dispose();
    ...
    {
        using var manager = new ChunkManager<DefaultConfig>(new DefaultConfig(), NativeMemoryAllocator.Shared);
