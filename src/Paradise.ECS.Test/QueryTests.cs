...
public sealed class QueryTests : IDisposable
{
    ...
    public async Task Chunks_MultipleArchetypes_ReturnsAllChunks()
    {
        ...
        var positionMask = ImmutableBitSet<Bit64>.Empty.Set(TestPosition.TypeId);
        var archetype1 = _registry.GetOrCreate((HashedKey<ImmutableBitSet<Bit64>>)positionMask);
    ...
    public async Task Chunks_EmptyArchetype_SkipsArchetype()
    {
        ...
        var positionMask = ImmutableBitSet<Bit64>.Empty.Set(TestPosition.TypeId);
        _ = _registry.GetOrCreate((HashedKey<ImmutableBitSet<Bit64>>)positionMask);
    ...
    public async Task EntityIds_ConsecutiveEmptyArchetypes_SkipsAll()
    {
        ...
        _ = _registry.GetOrCreate((HashedKey<ImmutableBitSet<Bit64>>)mask1);
        ...
        var mask3 = ImmutableBitSet<Bit64>.Empty.Set(TestPosition.TypeId).Set(TestHealth.TypeId);
