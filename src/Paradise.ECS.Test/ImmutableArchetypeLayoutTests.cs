...
public sealed class ImmutableArchetypeLayoutTests
{
    ...
    public async Task Create_EmptyMask_CreatesValidLayout()
    {
        ...
        try
        {
            var layout = new ImmutableArchetypeLayout<Bit64, ComponentRegistry>(data);
    ...
    {
        var offset0 = ImmutableArchetypeLayout<Bit64, ComponentRegistry>.GetEntityIdOffset(0);
        var offset1 = ImmutableArchetypeLayout<Bit64, ComponentRegistry>.GetEntityIdOffset(1);
