...
/// </remarks>
public sealed class TaggedWorld<TMask, TRegistry, TConfig, TEntityTags, TTagMask> : IDisposable
    ...
    where TTagMask : unmanaged, IBitSet<TTagMask>
{
        ...
        ChunkTagRegistry<TTagMask> chunkTagRegistry)
    {
        ...
        _world = new World<TMask, TRegistry, TConfig>(config, sharedMetadata, chunkManager);
    }

    /// <summary>
    /// Gets the underlying World instance.
    /// </summary>
    public World<TMask, TRegistry, TConfig> World => _world;

    /// <summary>
    /// Gets the archetype registry for this world.
    /// </summary>
    public ArchetypeRegistry<TMask, TRegistry, TConfig> ArchetypeRegistry => _world.Registry;
    ...
    /// </summary>
    internal IReadOnlyList<Archetype<TMask, TRegistry, TConfig>?> Archetypes => _world.Archetypes;
    ...
    /// </example>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TaggedWorldQueryBuilder<TMask, TRegistry, TConfig, TEntityTags, TTagMask> Query()
        => new(this);
    ...
    private void RecomputeChunkMask(ChunkHandle chunkHandle, Archetype<TMask, TRegistry, TConfig> archetype, int chunkIndex)
    {
    ...
    private TTagMask ComputeActualChunkMask(Archetype<TMask, TRegistry, TConfig> archetype, int chunkIndex)
    {
...
public static class QueryBuilderTaggedWorldExtensions
{
    extension<TMask>(QueryBuilder<TMask> builder) where TMask : unmanaged, IBitSet<TMask>
    {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public WorldQuery<TMask, TRegistry, TConfig> Build<TRegistry, TConfig, TEntityTags, TTagMask>(
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public WorldChunkQuery<TMask, TRegistry, TConfig> BuildChunk<TRegistry, TConfig, TEntityTags, TTagMask>(
            TaggedWorld<TMask, TRegistry, TConfig, TEntityTags, TTagMask> taggedWorld)
            where TRegistry : IComponentRegistry
            where TConfig : IConfig, new()
            where TEntityTags : unmanaged, IComponent, IEntityTags<TTagMask>
