...
// It resolves to: TaggedWorld<SmallBitSet<ulong>, ComponentRegistry, GameConfig, EntityTags, TagMask>
...
var world = new World(config, chunkManager, sharedMetadata, chunkTagRegistry);
