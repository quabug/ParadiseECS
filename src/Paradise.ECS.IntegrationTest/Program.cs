...
// The 'World' type is generated by the source generator from [WorldDefault] on GameConfig
// It resolves to: World<Bit64, ComponentRegistry, GameConfig>
...
using var chunkManager = new ChunkManager(config);

// Create the world using the generated World alias
var world = new World(config, sharedMetadata, chunkManager);
